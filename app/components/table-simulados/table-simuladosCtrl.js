var fessmodule = angular.module("simulados", ['angular.filter', 'ngAnimate']);
...
fessmodule.controller('ctrlRead', function ($scope, $filter) {
    ...
    $scope.printToCart = function(printSectionId) {
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="style.css" /> <style>.pagination{display:none;]</style></head><body onload="window.print()">' + innerContents + '</html>');
